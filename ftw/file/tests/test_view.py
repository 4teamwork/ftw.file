...
class TestFileName(TestCase):
    ...
    @browsing
    def test_logged_in_user_sees_author_when_allowAnonymousViewAbout(self, browser):
    ...
    @browsing
    def test_anonymous_user_sees_author_when_allowAnonymousViewAbout(self, browser):
